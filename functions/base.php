...
function bootstrap_menus() {
	class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$item_output .= ( $args->has_children ) ? ' <span class="fa fa-chevron-down"></span></a>' : '</a>';
...
/**
 * Registers all installed shortcodes (does not include [posttype-list]
 * shortcodes generated by custom post type classes.)
 *
 * @return void
 * @author Jim Barnes
 **/
