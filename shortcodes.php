        ...
        <div ng-if="uidSearchCtrl.results.length && uidSearchCtrl.searchQuery.term.length > 2" ng-cloak>
            ...
            <div class="row">
                <div class="col-md-4" ng-repeat="result in uidSearchCtrl.results">
                    ...
                    <a href="https://s3.amazonaws.com/web.ucf.edu/uid/{{ result.slug }}/{{ result.slug }}.zip" class="btn btn-ucf btn-download">Download <span class="glyphicons glyphicons-download-alt" aria-hidden="true"></span></a>
                </div>
            </div>
        </div>
    </div>
